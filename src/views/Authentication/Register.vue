...
import ModuleCarousel from './components/ModuleCarousel.vue'
  ...
  >
    <ElScrollbar class="h-full">
      <div class="relative flex mx-auto min-h-100vh">
        <div :class="`${prefixCls}__left flex-1 bg-gray-900 relative p-30px lt-xl:hidden`">
        ...
        <div class="flex-1 p-30px lt-sm:p-10px dark:bg-[var(--login-bg-color)] relative">
          ...
          <Transition appear enter-active-class="animate__animated animate__bounceInRight">
            ...
            >
              <RegisterForm class="p-20px h-auto m-auto lt-xl:rounded-3xl lt-xl:light:bg-white" />
            </div>
          </Transition>
        </div>
      </div>

          ...
          <table class="table table-bordered">
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <div style="width: 99%">
                    <Editor v-model="sla.vendor_responsibilities" />
              ...
              <tr>
                ...
                <td>
                  <div style="width: 99%">
                    <Editor v-model="sla.client_responsibilities" />
              ...
              <tr>
                ...
                <td>
                  <el-radio-group v-model="sla.report_frequency">
                    ...
                    <el-radio border label="Biannually" />
                    <el-radio border label="Annually" />
                  </el-radio-group>
                  <!-- <el-select
  ...
  methods: {
    ...
    setupSLAValues() {
      ...
      this.sla.performance_metrics =
        this.sla.performance_metrics.length > 0
          ? this.sla.performance_metrics
    ...
    showSLA() {
      this.loading = true
      const saveScoreResource = new Resource('vdd/vendor-contracts/show-sla')
      saveScoreResource
        .vGet(this.selectedContract.sla.id)
        .then((response) => {
